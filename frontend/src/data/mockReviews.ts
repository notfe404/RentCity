...
// ============================================================
// Mock Reviews — Đánh giá tiếng Việt
// ============================================================
...
export const MOCK_REVIEWS: MockReview[] = [
  {
    ...
    comment: 'Xe rất mới và sạch sẽ, nhân viên giao xe đúng giờ. Sẽ quay lại lần sau!',
  ...
  },
  {
    ...
    comment: 'Xe chạy êm, tiết kiệm xăng. Nhân viên nhiệt tình hỗ trợ. Chỉ hơi thiếu nước rửa kính.',
  ...
  },
  {
    ...
    comment: 'Honda City rất tốt, nội thất sạch đẹp. Giao xe nhanh tại sân bay Nội Bài.',
  ...
  },
  {
    ...
    overallRating: 5, vehicleRating: 5, serviceRating: 5,
    comment: 'Tucson chạy cực đã, cabin rộng, gia đình 4 người đi Hạ Long rất thoải mái.',
  ...
  },
  {
    ...
    overallRating: 5, vehicleRating: 5, serviceRating: 5,
    comment: 'Carnival quá đỉnh! Ghế VIP hàng 2 ngồi như máy bay hạng thương gia. Rất recommend.',
  ...
  },
  {
    ...
    comment: 'VF8 lái yên tĩnh, công nghệ hiện đại. Chỉ hơi lo trạm sạc trên đường dài.',
  ...
  },
  {
    ...
    overallRating: 5, vehicleRating: 5, serviceRating: 4,
    comment: 'Fortuner chạy đường dài Hà Nội - Sapa cực tốt, gầm cao vượt mọi đoạn xấu.',
  ...
  },
  {
    ...
    overallRating: 5, vehicleRating: 5, serviceRating: 5,
    comment: 'Mercedes C200 xứng đáng giá tiền. Nội thất sang trọng, đèn ambient rất đẹp.',
  ...
  },
  {
    ...
    comment: 'CX-5 nội thất đẹp, lái êm. Thiết kế KODO rất cuốn hút. Phù hợp đi công tác.',
  ...
  },
  {
    ...
    overallRating: 4, vehicleRating: 4, serviceRating: 5,
    comment: 'Xpander giá rẻ mà rộng, chở được 7 người thoải mái. Gầm cao không sợ ngập.',
